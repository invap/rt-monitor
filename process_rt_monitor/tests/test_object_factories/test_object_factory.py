...
from process_rt_monitor.process.process_node.task import (
    Task,
)
from process_rt_monitor.process.process import (
    ProcessSpecification,
)
from process_rt_monitor.tests.test_object_factories.test_encoded_event_factory import (
    TestEncodedEventFactory,
)
from process_rt_monitor.tests.test_object_factories.test_logic_object_factory import (
...
class TestObjectFactory(TestLogicObjectFactory, TestEncodedEventFactory):
    ...
    def workflow_specification_with_one_task(self):
        ...
        return ProcessSpecification(ordered_nodes, dependencies)
