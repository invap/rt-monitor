...
def build_rabbitmq_server_connections(file_path):
    global rabbitmq_event_server_connection, rabbitmq_result_log_server_connection, rabbitmq_framework_server_connection
    try:
        f = open(file_path, "rb")
    ...
    try:
        ...
        rabbitmq_framework_server_connection = RabbitMQ_server_incoming_connection(
            server_info,
            connection_attempts,
            retry_delay,
            exchange,
